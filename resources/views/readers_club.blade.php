    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-7 main_content">
                <div class="row">
                    <p>The purpose is to share and understand the tradition of literary reading of multilingual authors
                        from
                        around the world.</p>
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            <tr>
                                <td class="text-center">Ms. Aparna Kaushal</td>
                                <td class="text-center">Co-ordinator</td>
                                <td class="text-center">9041393016</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
