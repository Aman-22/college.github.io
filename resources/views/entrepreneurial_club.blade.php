    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-7 main_content">
                <div class="row">
                    <p>A group of entrepreneurs that meet frequently in order to support each other and share their
                        experiences.</p>
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            <tr>
                                <td class="text-center">Dr. J.K. Sehgal</td>
                                <td class="text-center">Chairperson</td>
                                <td class="text-center">9417041129</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
