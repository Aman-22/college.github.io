    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-7 main_content">
                <div class="row">
                    <p>The purpose is to stimulate the creativity of budding writers by logically understanding and
                        balancing the thoughts on page.</p>
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            <tr>
                                <td class="text-center">Ms. Anuradha Bhattacharya</td>
                                <td class="text-center">Co-ordinator</td>
                                <td class="text-center">9878748922</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
