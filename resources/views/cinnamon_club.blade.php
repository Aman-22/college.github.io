    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-7 main_content">
                <div class="row">
                    <p>The purpose is to make the grl students aware of their power and strength to enable them to
                        develop a voice.</p>
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            <tr>
                                <td class="text-center">Ms. Kirandeep Dhillon</td>
                                <td class="text-center">Co-ordinator</td>
                                <td class="text-center">9914002737</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
